...
Tu pendejada se está enviando espere un rato..`;
...
handler.command = handler.help = ['play10'];
handler.tags = ['dl'];
handler.diamond = 4;
...
/*No borren los créditos o Miguel les va aparecer a bajo de la cama*/