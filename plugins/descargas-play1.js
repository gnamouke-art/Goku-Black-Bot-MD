...
const texto1 = `*𝑮𝑶𝑲𝑼-𝑩𝑳𝑨𝑪𝑲-𝑩𝑶𝑻-𝑴𝑫*
...
image: { url: yt_play[0].thumbnail }, caption: texto1, contextInfo: { externalAdReply: { title: '♡  ͜ ۬︵࣪᷼⏜݊᷼𝘿𝙚𝙨𝙘𝙖𝙧𝙜𝙖𝙨⏜࣪᷼︵۬ ͜ ', body: '𝑮𝑶𝑲𝑼𝑩𝑳𝑨𝑪𝑲𝑩𝑶𝑻', sourceUrl: cn, thumbnail: logo7 }}, quoted: estilo});
try {
await m.react(rwait);
...
const yt_play = await search(args.join(' '));
const ytplay2 = await yts(text);
const texto1 = `*𝑮𝒐𝒌𝒖-𝑩𝒍𝒂𝒄𝒌-𝑩𝒐𝒕-𝑴𝑫*
...
await conn.sendMessage(m.chat, {
image: { url: yt_play[0].thumbnail }, caption: texto1, contextInfo: { externalAdReply: { title: '♡  ͜ ۬︵࣪᷼⏜݊᷼𝘿𝙚𝙨𝙘𝙖𝙧𝙜𝙖𝙨⏜࣪᷼︵۬ ͜ ', body: '𝑮𝒐𝒌𝒖𝑩𝒍𝒂𝒄𝒌-𝑩𝒐𝒕-𝑴𝑫', sourceUrl: cn, thumbnail: logo7 }}, quoted: estilo});
try {
await m.react(rwait);
const apiUrl = `https://delirius-apiofc.vercel.app/download/ytmp4?url=${encodeURIComponent(yt_play[0].url)}`;
const apiResponse = await fetch(apiUrl);
...
await conn.sendMessage(m.chat, {
image: { url: yt_play[0].thumbnail }, caption: texto1, contextInfo: { externalAdReply: { title: '♡  ͜ ۬︵࣪᷼⏜݊᷼𝘿𝙚𝙨𝙘𝙖𝙧𝙜𝙖𝙨⏜࣪᷼︵۬ ͜ ', body: '𝗚𝗢𝗞𝗨𝗕𝗟𝗔𝗖𝗞-𝗕𝗢𝗧-𝗠𝗗', sourceUrl: cn, thumbnail: logo7 }}, quoted: estilo});
try {
await m.react(rwait);
const apiUrl = `https://delirius-apiofc.vercel.app/download/ytmp4?url=${encodeURIComponent(yt_play[0].url)}`;
const apiResponse = await fetch(apiUrl);
...
const yt_play = await search(args.join(' '));
const ytplay2 = await yts(text);
const texto1 = `*𝗚𝗢𝗞𝗨-𝗕𝗟𝗔𝗖𝗞-𝗕𝗢𝗧-𝗠𝗗*
...
await conn.sendMessage(m.chat, {
image: { url: yt_play[0].thumbnail }, caption: texto1, contextInfo: { externalAdReply: { title: '♡  ͜ ۬︵࣪᷼⏜݊᷼𝘿𝙚𝙨𝙘𝙖𝙧𝙜𝙖𝙨⏜࣪᷼︵۬ ͜ ', body: '𝐺𝑂𝐾𝑈-𝐵𝐿𝐴𝐶𝐾-𝐵𝑂𝑇-𝑀𝐷', sourceUrl: cn, thumbnail: logo7 }}, quoted: estilo});
try {
await m.react(rwait);
const apiUrl = `https://delirius-apiofc.vercel.app/download/ytmp4?url=${encodeURIComponent(yt_play[0].url)}`;
const apiResponse = await fetch(apiUrl);
